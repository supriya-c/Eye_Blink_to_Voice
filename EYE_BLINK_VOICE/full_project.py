            ...
            if line == '1':
                ...
                if self.image_name=="yes.jpg":
                    if flag==1:
                        ...
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="Iam Hungry!!!Feed me")
                    ...
                    if flag==2:
                        ...
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="Iam Thirsty")
                    call = client.calls.create(
                    ...
                    if flag==3:
                        print("I need snacks")
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="I want Snacks")
                    call = client.calls.create(
                    ...
                    if flag==4:
                        ...
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="I want to watch TV")
                    call = client.calls.create(
                    ...
                    if flag==5:
                        ...
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="I want to make a call")
                    call = client.calls.create(
                    ...
                    if flag==6:
                        print("I need to pee")
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="I want to use washroom")
                    call = client.calls.create(
                    ...
                    if flag==7:
                        print("I need coffee")
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="I want to drink coffee or tea")
                    call = client.calls.create(
                   ...
                   print(call.sid)
                    if flag==8:
                        ...
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="I want to drink milk")
                    call = client.calls.create(
                    ...
                    if flag==9:
                        ...
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="I want fruits")
                    call = client.calls.create(
                    ...
                    if flag==10:
                        ...
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO"],body="I want juice")
                    call = client.calls.create(
                    ...
                    if flag==11:
                        ...
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="Emergency!Call the doctor")
                    call = client.calls.create(
                    ...
                    if flag==12:
                        ...
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="I want curdrice to eat")
                    call = client.calls.create(
                        twiml='<Response><Say>Its an Emergency!Please call the doctor!</Say></Response>',
                        to=os.environ['CONTACT_NO'],
                        from_=os.environ['TWILIO_NO'])
                    ...
                    if flag==13:
                        ...
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="I want idli sambar to eat")
                    call = client.calls.create(
                    ...
                    if flag==14:
                        ...
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="I want ragi malt")
                    call = client.calls.create(
                    ...
                    if flag==15:
                        ...
                        client.api.account.messages.create(to=os.environ['CONTACT_NO'],from_=os.environ['TWILIO_NO'],body="I want khichdi to eat")
                    call = client.calls.create(
